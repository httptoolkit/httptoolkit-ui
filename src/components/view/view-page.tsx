...
const ViewPageKeyboardShortcuts = (props: {
    ...
    useHotkeys('Ctrl+m, Cmd+m', (event) => {
        if (props.isPaidUser && (selectedEvent?.isHttp() || props.isMultiSelection)) {
            props.onBuildRuleFromExchange();
            event.preventDefault();
        }
    }, [selectedEvent, props.isMultiSelection, props.onBuildRuleFromExchange, props.isPaidUser]);
    ...
    render(): JSX.Element {
        ...
        return <div className={this.props.className}>
            <ViewPageKeyboardShortcuts
                ...
                onBuildRuleFromExchange={this.onBuildRuleFromSelectedExchanges}
