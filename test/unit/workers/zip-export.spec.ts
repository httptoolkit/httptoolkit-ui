...
describe('ZIP export worker round-trip', function () {
    ...
    it('handles Race A: an abort posted immediately after worker dispatch', async () => {
        ...
        // Abort synchronously, immediately after callApi posts the worker
        // message. This exercises the race where the cancelPort receives an
        // abort before the worker has reached cancelPort.start().
        controller.abort();
